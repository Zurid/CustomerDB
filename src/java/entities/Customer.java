...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "AppUser.findAll", query = "SELECT t FROM Customer t")
    ,     
...
public class Customer extends BaseEntity implements Serializable {
    ...
    public boolean identical(final Object object) {
        ...
        return eq(customerId, o.customerId)
                && eq(addressline1, o.addressline1)
                && eq(addressline2, o.addressline2)
                && eq(city, o.city)
                && eq(state, o.state)
                && eq(phone, o.phone)
                && eq(fax, o.fax)
                && eq(name, o.name)
                && eq(email, o.email)
                && eq(creditLimit, o.creditLimit)
//                && eq(zip, o.zip)
//                && eq(discountCode, o.discountCode)
                ;
    }
}
